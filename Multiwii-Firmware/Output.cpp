...
#if defined(PROMINI)
  #if defined(NRF24_RX)
  uint8_t PWM_PIN[8] = {5,6,3,9,A2,12,10,11};   //{9,6,5,3,A2,12,10,11}; old use pin 6 and 5 instead of 10 and 11 - only valid for quad!
...
void writeMotors() { // [1000;2000] => [125;250]
  ...
  motor[3] = (motor[3]-1000) << 1;
    ...
    #if defined(NRF24_RX) // for nRF24L01 receiver, use pin 5 and 6 instead of 10 and 11 !!! pakeistas 
      #ifndef EXT_MOTOR_RANGE
